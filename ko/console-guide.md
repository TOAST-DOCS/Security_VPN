...
<SSL VPN 계정 발급 및 ACL 신청 프로세스\>
   ...
   3. SSL VPN 신청서 접수(1:1문의) : NHN Cloud (공공기관용) [1:1 문의](https://www.beta-gov-nhncloud.com/kr/support/inquiry?alias=tab3_08) 서비스/기타/Security 유형으로 접수 신청(접수일 기준으로 3일 이내 처리 및 회신)
